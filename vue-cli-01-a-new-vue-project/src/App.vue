<template>
  <section>
    ...
    <ul>
        <!-- custom child elementler için v-for kullanımında key kullanımı zorunludur
        parent elemente verdiğimiz attributeler dinamikse v-bind veya : kullanırız değilse direk attribute yazarız
        -->
      <friend-contact
        ...
        :is-favorite="friend.isFavorited"
        @toggle-favorite="toggleFavoriteStatus"
        @delete="deleteContant"
      ></friend-contact>
    </ul>
  </section>
</template>
  ...
  methods: {
    ...
    */
    addContact(name, phone, email) {
        ...
        this.friends.push(newFriendContant)
    },
    deleteContant(id) {
        this.friends.splice(this.friends.findIndex(friend => friend.id === id), 1);
    }
  }
};
</script>
