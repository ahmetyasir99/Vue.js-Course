<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div> <!--value değerlerini farklı yaparak ve interest'i liste yaparak çözüm bulduk-->
...
export default {
  ...
  data() {
    return {
      userName: '',
      userAge: null,
      referrer: 'google',//dropdown select elemanında initial value olarak değer koyuyoruz
      interest: [], //array halinde seçili olanları verir, tek element olsa true false verir başta false yaparsak 
      how: null,
      rating: null,
  ...
  methods: {
    submitForm() {
      ...
      console.log(this.interest) //array halinde seçili olanları verir
      this.userName = '';
